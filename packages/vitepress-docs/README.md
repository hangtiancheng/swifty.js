...
```bash
pnpm add -D @swifty.js/vitepress-docs
```
...
import { excludePrivatePages, privateDocsPlugin } from "@swifty.js/vitepress-docs";
...
| -------------- | --------- | ------------------------------------ | ------------------------------------- |
| `clientModule` | `string`  | `"@swifty.js/vitepress-docs/client"` | Runtime module the page stubs import. |
...
### `@swifty.js/vitepress-docs/client`
